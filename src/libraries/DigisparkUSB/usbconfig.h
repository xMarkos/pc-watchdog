 ...
 */
#define USB_CFG_VENDOR_NAME     'x','m','a','r','k','o','s','.','e','u'
...
#define USB_CFG_DEVICE_NAME     'W','a','t','c','h','d','o','g'
 ...
 */
#define USB_CFG_INTERFACE_CLASS     0  /* HID */ /* define class here if not at device level */
